    ...
    <div className="container">
        <div className="row">
            <div className="col-lg-4 col-md-4">
                ...
                <a href="/blog" target="_blank"><button className="imageButton">Learn more</button></a>
                </div>
            </div>
            <div className="col-lg-4 col-md-4">
            ...
            <div className="col-lg-4 col-md-4">
                ...
                <div className="text-center">
                <a href="/blog" target="_blank"><button className="imageButton marginTop42">Learn more</button></a>
                </div>
            </div>
        </div>
    </div>
